    ...
    <div className="w-full bg-black text-white relative overflow-x-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen text-center px-6 pt-12 pb-16">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <button
            className="flex items-center space-x-2 px-8 py-4 rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold text-lg hover:opacity-80 transition"
          ...
          <button
            className="flex items-center space-x-2 px-8 py-4 rounded-xl bg-black border border-gray-600 text-white text-lg hover:bg-gray-800 transition"
